...
(()=>{
    const e = new Error("Cannot find module '@/components/forms/selectField'");
...
;
const SignIn = ()=>{
    const { register, handleSubmit, watch, formState: { errors, isSubmitting } } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useForm"])({
        defaultValues: {
            fullName: '',
            email: '',
            password: '',
...
//# sourceMappingURL=_1a6dcc9d._.js.map